...
- Retrieves storage usage quantities (GB stored) by meter type
...
**Parameters:**
- `BillingAccountId`: EA billing account ID (defaults to configured value)
- `Timeframe`: Query period—MonthToDate, BillingMonthToDate, or TheLastMonth (default: MonthToDate)
