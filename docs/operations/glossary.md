...
[Capacity reservations](https://learn.microsoft.com/en-us/azure/virtual-machines/capacity-reservation-overview) ensure availability of specific VM capacity without commitment discounts. Reserved instances and savings plans provide pricing discounts in exchange for one- or three-year commitments but don't guarantee capacity.
