...
|----------|-------------|---------|
| **Education** | Walk through azcapman runbooks | Customer understands the capacity journey |
...
**CSM handoff to CSA:** When capacity conversations require engineering design reviews—forecast validation, architecture changes, or complex quota strategies.
...
|----------|-----|----------|
| **azcapman runbooks** | [aka.ms/azcapman](https://aka.ms/azcapman) | Complete capacity governance guide |
